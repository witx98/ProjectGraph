#include "pch.h"
#include "..\\..\\Projekt\\Wojtas\Plik.cpp"
#include "..\\..\\Projekt\\Wojtas\\Funkcje_do_Stringow.cpp"
#include "..\\..\\Projekt\\Wojtas\\Funkcja.cpp"
#include "..\\..\\Projekt\\Wojtas\\znajdz_definicje_funkcji.cpp"
#include "..\\..\\Projekt\\Wojtas\\Modul.cpp"
...
namespace PlikTest {
	...
	/*TEST(Modul_W_Pliku, CASE_1) {
		plik::Plik plik("namespace_test.cpp");
		plik.znajdz_moduly();
...
namespace Polaczenia_Miedy_Funkcjami {
	TEST(Polaczenia_Miedy_Funkcjami,GdyIstnieje1) {
		funkcja::Funkcja funkcja("sortowanie_przez_scalanie");
		std::fstream otwarty_plik;
		otwarty_plik.open("plik_definicje_testowy_3.cpp");
		funkcja::Funkcja fun2("scal");
	...
	TEST(Polaczenia_Miedy_Funkcjami, Szuka_Samej_Siebie) {
		...
		std::fstream otwarty_plik;
		otwarty_plik.open("plik_definicje_testowy_3.cpp");
		funkcja::Funkcja fun2("sortowanie_przez_scalanie");
		funkcja.znajdz_polaczone_funkcje(fun2, otwarty_plik);
	...
	TEST(Polaczenia_Miedy_Funkcjami, Gdy_Nie_Ma) {
		funkcja::Funkcja funkcja("scal");
		std::fstream otwarty_plik;
		otwarty_plik.open("plik_definicje_testowy_3.cpp");
		funkcja::Funkcja fun2("sortowanie_przez_scalanie");
		funkcja.znajdz_polaczone_funkcje(fun2, otwarty_plik);
		for (auto i : funkcja.polaczenia_miedzy_funkcjami)
